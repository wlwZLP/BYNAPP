...
- (void)setup{
    ...
    UITextField * NumTextField = [[UITextField alloc] initWithFrame:CGRectMake(MainView.ZLP_width -80, 12 , 30, 25)];
    NumTextField.text = @"1";
//    NumTextField.backgroundColor = YYMMColor;
    ...
    self.BuyNumTextField = NumTextField;
