//
//  BrandSearchDataCollectionViewCell.m
//  BYNAPP
//
...
@interface BrandSearchDataCollectionViewCell ()
...
@implementation BrandSearchDataCollectionViewCell
...
- (void)setup{
    ...
    CouponImage.image = [UIImage imageNamed:@"brandsearch"];
