//
//  PersonNoVipheadCollectionViewCell.m
//  BYNAPP
//
...
@implementation PersonNoVipheadCollectionViewCell
...
-(void)WdrawButtonClick{
    ...
    self.PersonheadBtnBlockClick(@"提现");
    
}

-(void)MoneybtnClick{
    
    self.PersonheadBtnBlockClick(@"报表");
...
-(void)SetImgButtonClick{
    ...
    self.PersonheadBtnBlockClick(@"设置");
