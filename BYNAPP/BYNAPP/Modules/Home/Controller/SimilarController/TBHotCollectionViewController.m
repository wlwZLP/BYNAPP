//
//  TBHotCollectionViewController.m
//  BYNAPP
//
...
@interface TBHotCollectionViewController ()
...
@implementation TBHotCollectionViewController
...
-(void)GetSelfViewControllerNetworkData{
     ...
     NSDictionary * dict = @{@"mall_id":@"1",@"sort":self.HeadSort,@"activity_type":@"3",@"page":[NSString stringWithFormat:@"%ld",(long)self.RefreshCount]};
